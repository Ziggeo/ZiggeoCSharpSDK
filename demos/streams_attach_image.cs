...
/*
	...
	5. file_path - path to image file

*/
namespace Streams_Attach_Image
{
	public class Streams_Attach_Image
	{
		public static void Main(string[] args)
		{
			...
			Console.Write(ziggeo.streams().attach_image(video_token, stream_token, arguments, file_path));
		}
	}
}